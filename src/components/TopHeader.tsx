    ...
    <>
      <header className="fixed top-0 right-0 w-[calc(100%-260px)] h-[64px] bg-[#f7f9fb] flex justify-between items-center px-6 z-40 border-b border-slate-200/80">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Explicitly visible Logout button for all roles */}
          <button
            onClick={() => {
              if (onLogout) onLogout();
            }}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-rose-50 border border-rose-200 text-rose-600 hover:text-rose-800 hover:bg-rose-100 rounded-md transition-colors ml-2 font-bold text-xs shadow-sm"
            title="Logout"
          >
